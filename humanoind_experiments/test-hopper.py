...
weights='/misc/scratch03/reco/bhattaga/data/i-vectors/dnn_projects/RL/cloning-priority-humanoid-sna/weights/s2s_rsr_minloss_valincr.npz'
...
def main():
  ...
  data = np.load('/misc/data15/reco/bhattgau/Rnn/code/Code_/RL/homework/hw1/latest-data/humanoid/expert-actions-humanoid-250.npy')
  data = np.asarray(data,dtype='float32')
  data = np.reshape(data,(data.shape[0],data.shape[1],17)) 
  
  sdata = np.load('/misc/data15/reco/bhattgau/Rnn/code/Code_/RL/homework/hw1/latest-data/humanoid/expert-states-humaniod-250.npy')
  ...
  print(demo.shape,sdemo.shape)

  cdemo = np.concatenate([sdemo,demo],axis=2)
  print(cdemo.shape)
